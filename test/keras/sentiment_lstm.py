...
def train():
    ...
    print("load_data:", len(combined), len(y))

    # sentences = [['first', 'sentence'], ['second', 'sentence']]
    print('Tokenising...')
    sentences = tokenizer(combined)
    print("tokenizer:", len(sentences))

    print('Training a Word2vec model...')
    index_dict, word_vectors, combined = train_word2vec(sentences)
...
if __name__ == '__main__':
    ...
    test_set = ['电池充完了电连手机都打不开.简直烂的要命.真是金玉其外,败絮其中!连5号电池都不如',
